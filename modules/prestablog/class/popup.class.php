...
class PopupClass extends ObjectModel
{
    ...
    public function displayForm($do = 'add')
    {
        ...
        if (!Tools::isSubmit('editpopup') && !Tools::getIsset('error1') && !Tools::getIsset('error2')) {
            ...
            $fields_value = [
                'id_prestablog_popup' => (int) $object_model->id_prestablog_popup,
                'date_start' => (Tools::getIsset(Tools::getValue['1']) ? Tools::getValue['1'] : $object_model->date_start),
                'date_stop' => (Tools::getIsset(Tools::getValue['2']) ? Tools::getValue['2'] : $object_model->date_stop),
                'height' => (Tools::getIsset(Tools::getValue['3']) ? Tools::getValue['3'] : (int) $object_model->height),
                'width' => (Tools::getIsset(Tools::getValue['4']) ? Tools::getValue['4'] : (int) $object_model->width),
                'delay' => (Tools::getIsset(Tools::getValue['5']) ? Tools::getValue['5'] : (int) $object_model->delay),
                'expire' => (Tools::getIsset(Tools::getValue['6']) ? Tools::getValue['6'] : (int) $object_model->expire),
                'expire_ratio' => (int) $object_model->expire_ratio,
                'theme' => $object_model->theme,
                'restriction_rules' => (int) $object_model->restriction_rules,
                'restriction_pages' => $object_model->restriction_pages,
                'actif' => (bool) $object_model->actif,
                'footer' => (bool) $object_model->footer,
                'pop_colorpicker_content' => (Tools::getIsset(Tools::getValue['8']) ? Tools::getValue['8'] : $object_model->pop_colorpicker_content),
                'pop_colorpicker_modal' => (Tools::getIsset(Tools::getValue['9']) ? Tools::getValue['9'] : $object_model->pop_colorpicker_modal),
                'pop_colorpicker_btn' => (Tools::getIsset(Tools::getValue['10']) ? Tools::getValue['10'] : $object_model->pop_colorpicker_btn),
                'pop_colorpicker_btn_border' => (Tools::getIsset(Tools::getValue['11']) ? Tools::getValue['11'] : $object_model->pop_colorpicker_btn_border),
                'pop_opacity_content' => $object_model->pop_opacity_content,
                'pop_opacity_modal' => $object_model->pop_opacity_modal,
                'pop_opacity_btn' => $object_model->pop_opacity_btn,
            ];
        ...
        $l01 = $this->l('If the content does not fit in, a scroll bar will appear');
        $ppc = AdminController::$currentIndex . '&configure=prestablog';
        $tk = Tools::getAdminTokenLite('AdminModules');
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'col' => '2',
                        'desc' => $this->l('For the popup to appear constantly, turn it to 0'),
                    ],
                    [
                    ...
                    [
                        ...
                        'hint' => $this->l('This option shows or hides the footer popup with the close button.') . '
                    <br />' . $this->l('Its closing is also always possible without button.'),
                        'name' => 'footer',
                        'is_bool' => true,
                        'values' => [
                            [
