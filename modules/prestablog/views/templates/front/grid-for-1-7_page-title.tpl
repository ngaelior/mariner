{*
   ...
   * @license   Commercial
   ...
   <article id="prestablogfront" itemscope itemtype="https://schema.org/BlogPosting">
    {if isset($news_Image) && $prestablog_config.prestablog_view_news_img}<img src="{$prestablog_theme_upimg|escape:'html':'UTF-8'}thumb_{$news->id|intval}.jpg?{$md5pic|escape:'htmlall':'UTF-8'}" class="news" alt="{$news->title|escape:'htmlall':'UTF-8'}" itemprop="image">{/if}
