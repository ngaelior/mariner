...
<div class="footer-container">
    <div class="container">
        ...
        <div class="row text-xs-center text-md-left" style="border-top: 1px solid #e5e5e5;margin-top: 30px">
            <div class="col-xs-12 col-md-6">
                <p class="">
                    {block name='copyright_link'}
                        <a style="color: rgba(119,119,119,.6)" href="https://www.prestashop.com" target="_blank"
            ...
            <div class="col-xs-12 col-md-6">
                <a class="text-xs-center text-md-right">
